...
import com.androidgrouplearning.mypetsapp.retrofit.ApiClient;
import com.androidgrouplearning.mypetsapp.retrofit.ApiInterface;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listener = new Adapter.RecyclerViewClickListener() {
            ...
            public void onRowClick(View view, final int position) {
                ...
                Intent intent = new Intent(MyPets.this, EditorActivity.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MyPets.this, EditorActivity.class));
            }
        });
    ...
    public void getPets(){
        ...
        call.enqueue(new Callback<List<Pets>>() {
            ...
            public void onResponse(Call<List<Pets>> call, Response<List<Pets>> response) {
                ...
                Log.i(MyPets.class.getSimpleName(), response.body().toString());
                adapter = new Adapter(petsList, MyPets.this, listener);
    ...
    public void updateLove(final String key, final int id, final Boolean love){
        ...
        call.enqueue(new Callback<Pets>() {
            ...
            public void onResponse(Call<Pets> call, Response<Pets> response) {
                ...
                Log.i(MyPets.class.getSimpleName(), "Response "+response.toString());

                String value = response.body().getValue();
                String message = response.body().getMassage();

                if (value.equals("1")){
                    Toast.makeText(MyPets.this, message, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(MyPets.this, message, Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<Pets> call, Throwable t) {
                Toast.makeText(MyPets.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
